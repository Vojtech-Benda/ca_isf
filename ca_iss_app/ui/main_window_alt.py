...
class Ui_win_main_window(object):
    def setupUi(self, win_main_window):
        ...
        self.pag_drr.setGeometry(QRect(0, 0, 486, 588))
        ...
        self.led_thresh = QLineEdit(self.pag_drr)
        self.led_thresh.setObjectName(u"led_thresh")
        self.led_thresh.setMaximumSize(QSize(50, 30))

        self.gridLayout_3.addWidget(self.led_thresh, 6, 1, 1, 1)
        ...
        self.label_22 = QLabel(self.pag_drr)
        ...
        self.labm_pre_ct_name.setMaximumSize(QSize(100, 16777215))
        ...
        self.labm_intra_ct_name.setMaximumSize(QSize(100, 16777215))
        ...
        self.label_23 = QLabel(self.pag_drr)
        ...
        self.pag_reg.setGeometry(QRect(0, 0, 486, 588))
        ...
        self.tob_main.setCurrentIndex(1)
    ...
    def retranslateUi(self, win_main_window):
        ...
        self.led_drr_width.setText(QCoreApplication.translate("win_main_window", u"1024", None))
        ...
        self.led_thresh.setText(QCoreApplication.translate("win_main_window", u"200", None))
        ...
        self.led_drr_height.setText(QCoreApplication.translate("win_main_window", u"1024", None))
