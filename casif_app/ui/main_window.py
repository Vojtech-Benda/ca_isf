...
class Ui_win_main_window(object):
    def setupUi(self, win_main_window):
        ...
        sizePolicy4.setHeightForWidth(self.lab_drr_height.sizePolicy().hasHeightForWidth())
        self.lab_drr_height.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.lab_drr_width.sizePolicy().hasHeightForWidth())
        self.lab_drr_width.setSizePolicy(sizePolicy4)
        ...
        sizePolicy4.setHeightForWidth(self.lab_ct_thresh.sizePolicy().hasHeightForWidth())
        self.lab_ct_thresh.setSizePolicy(sizePolicy4)
        ...
        sizePolicy5.setHeightForWidth(self.led_sigma_factors.sizePolicy().hasHeightForWidth())
        self.led_sigma_factors.setSizePolicy(sizePolicy5)
        ...
        sizePolicy5.setHeightForWidth(self.led_shrink_factors.sizePolicy().hasHeightForWidth())
        self.led_shrink_factors.setSizePolicy(sizePolicy5)
        ...
        self.gridLayout.addItem(self.verticalSpacer_5, 1, 0, 1, 2)
        ...
        QWidget.setTabOrder(self.pbu_drr_start, self.gvi_drr)
