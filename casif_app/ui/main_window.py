...
class Ui_win_main_window(object):
    def setupUi(self, win_main_window):
        ...
        self.gridLayout_3.addWidget(self.lab_sid, 5, 0, 1, 3)
        ...
        self.gridLayout_3.addWidget(self.led_drr_width, 3, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.led_drr_height, 4, 3, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lab_drr_height, 4, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.gbo_intraop_info, 13, 0, 1, 4)
        ...
        self.gridLayout_3.addWidget(self.pbu_drr_start, 9, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.lab_drr_width, 3, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.gbo_preop_info, 11, 0, 1, 4)
        ...
        self.gridLayout_3.addWidget(self.lab_ct_thresh, 6, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.labm_data_warning, 9, 2, 1, 2)
        ...
        self.lab_fixed_drr_2 = QLabel(self.tab_reg)
        self.lab_fixed_drr_2.setObjectName(u"lab_fixed_drr_2")

        self.gridLayout_4.addWidget(self.lab_fixed_drr_2, 3, 0, 1, 3)

        self.lab_fixed_drr_3 = QLabel(self.tab_reg)
        self.lab_fixed_drr_3.setObjectName(u"lab_fixed_drr_3")

        self.gridLayout_4.addWidget(self.lab_fixed_drr_3, 4, 0, 1, 3)
        ...
        self.gridLayout_4.addItem(self.verticalSpacer_6, 9, 0, 1, 1)
        ...
        self.lab_multires_levels_3 = QLabel(self.tab_reg)
        self.lab_multires_levels_3.setObjectName(u"lab_multires_levels_3")

        self.gridLayout_4.addWidget(self.lab_multires_levels_3, 5, 0, 1, 3)
        ...
        self.cob_optim_method = QComboBox(self.tab_reg)
        self.cob_optim_method.addItem("")
        self.cob_optim_method.addItem("")
        self.cob_optim_method.addItem("")
        self.cob_optim_method.setObjectName(u"cob_optim_method")
        self.cob_optim_method.setMinimumSize(QSize(0, 25))

        self.gridLayout_4.addWidget(self.cob_optim_method, 7, 3, 1, 1)

        self.tab_main.addTab(self.tab_reg, "")

        self.gridLayout.addWidget(self.tab_main, 0, 0, 1, 2)
        ...
        self.gridLayout.addWidget(self.gbo_image_info, 2, 0, 1, 2)
        ...
        sizePolicy5.setHeightForWidth(self.gvi_drr.sizePolicy().hasHeightForWidth())
        self.gvi_drr.setSizePolicy(sizePolicy5)
        ...
        self.gridLayout.addWidget(self.gvi_drr, 0, 3, 3, 1)

        self.horizontalSpacer_4 = QSpacerItem(10, 20, QSizePolicy.Policy.Fixed, QSizePolicy.Policy.Minimum)

        self.gridLayout.addItem(self.horizontalSpacer_4, 0, 2, 3, 1)
        ...
        QWidget.setTabOrder(self.tab_main, self.rbu_preop_drr)
        QWidget.setTabOrder(self.rbu_preop_drr, self.rbu_intraop_drr)
        QWidget.setTabOrder(self.rbu_intraop_drr, self.led_drr_width)
        ...
        QWidget.setTabOrder(self.pbu_drr_start, self.cbo_visualization)
        ...
        QWidget.setTabOrder(self.led_upper_edge_thresh, self.gvi_drr)
        QWidget.setTabOrder(self.gvi_drr, self.led_multires_levels)
        ...
        QWidget.setTabOrder(self.led_sigma_factors, self.cob_optim_method)
        QWidget.setTabOrder(self.cob_optim_method, self.pbu_reg_start)
    ...
    def retranslateUi(self, win_main_window):
        ...
        self.lab_fixed_drr_2.setText(QCoreApplication.translate("win_main_window", u"Po\u010det registra\u010dn\u00edch \u00farovn\u00ed:", None))
        self.lab_fixed_drr_3.setText(QCoreApplication.translate("win_main_window", u"\u0160k\u00e1lovac\u00ed konstanty:", None))
        ...
        self.lab_multires_levels_3.setText(QCoreApplication.translate("win_main_window", u"Rozptyly Gaussova filtru:", None))
        self.led_sigma_factors.setText(QCoreApplication.translate("win_main_window", u"4; 1", None))
        ...
        self.cob_optim_method.setItemText(0, QCoreApplication.translate("win_main_window", u"Gradientn\u00ed sestup", None))
        self.cob_optim_method.setItemText(1, QCoreApplication.translate("win_main_window", u"Gradientn\u00ed sestup se zl. \u0159ezem", None))
        self.cob_optim_method.setItemText(2, QCoreApplication.translate("win_main_window", u"BFGS s omezenou pam\u011bt\u00ed", None))

        self.cob_optim_method.setCurrentText(QCoreApplication.translate("win_main_window", u"Gradientn\u00ed sestup", None))
